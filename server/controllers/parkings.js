...
module.exports = {
  ...
  if(!req.body.parkingSlotId || req.body.parkingSlotId==='' ||  req.body.parkingSlotId >10){ // condition assumes there are 10 slots, because of the amount seeded
      return res.status(400).send({ message: "You can't park without a parking slot!" });
  }
    return Parking
    .findOne({
      where: {
